...
public class MainActivity extends ActionBarActivity {
	...
	//If I had more time, I wanted to setup and on click listener for the tabs to clear the text views
	//so that it essentially "started over" when you came back to a tab 
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvContactInfoBrother=(TextView)findViewById(R.id.textViewContactInfoBrother);
        tvContactInfoHulkHogan=(TextView)findViewById(R.id.textViewContactInfoHulkHogan);
